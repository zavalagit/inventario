...
@section("scripts")
<script src="{{asset('js/pages/scripts/admin/usuario/index.js')}}" type="text/javascript"></script>
@endsection
                                ...
                                <div class="card-header text-center">
                                    <div class="row">
                                        <div class="col-12 col-md-8 text-center">
                                            @if (count($usuarios))
                                                <h4>LISTADO DE USUARIOS<span class="badge badge-warning badge-pill">{{$usuarios->count()}}</span></h4>
                                            @else
                                                <h4>LISTADO DE USUARIOS<span class="badge badge-warning badge-pill">0</span></h4>
                                            @endif
                                        </div>
                                        <div class="col-6 col-md-4"><a href="{{route('crear_usuario')}}" class="btn btn-success float-right">Crear usuario</a></div>
                                    </div>
                                    
                                </div>
                                <div class="card-body">
                                    <table id="tabla-usuario" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th scope="col">No.</th>
